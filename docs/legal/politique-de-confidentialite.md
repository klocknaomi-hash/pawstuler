<!-- Brouillon généré depuis app/src/config/legal.ts : à faire relire, puis à publier en ligne. -->

# Politique de confidentialité

Dernière mise à jour : 25 septembre 2026. Chez Pawstuler, tes données t’appartiennent. Cette page explique simplement ce que l’app garde, pourquoi, où, et comment exercer tes droits.
