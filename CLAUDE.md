...
- **Aventure du jour** : une seule carte verte sous la scène, comme à l'origine : le titre « Aventure du jour » est **dans** la carte (pas de titre au-dessus), et en dessous **une phrase qui change** : « 10 ⚡ · Milo explore Clairebourg », « Milo dort encore », « Milo est allé déposer son CV chez Boulangerie du Lac » (sans heure : elle est déjà dans la bulle de la scène), « Milo est rentré ! Découvre son aventure », « Milo a un entretien à 11 h 30 », « 10 ⚡ · Milo a un appel à passer », « Nouvelle aventure demain » ou en Premium « Prochaine aventure à 14 h 43 ». Au retour : **d'abord le récit** (2-3 phrases et la récompense), puis, plus discret, « Une nouvelle aventure sera possible demain ». Pas de journal.
- **Quota** (indépendant de l'énergie) : une aventure dure 5 à 10 minutes, puis Milo revient. **Gratuit : 1 aventure par jour**, la suivante « demain ». **Premium : 3 par jour au plus, avec 3 h d'attente qui commencent à son retour** (retour à 8 h 53 → suivante possible à 11 h 53). Les aventures non utilisées ne se cumulent pas. Heure réelle du téléphone.

### 5.5 ter Système miroir : Milo vit SA recherche, dans SA ville
- **Aucun lien entre tes candidatures et celles de Milo.** Milo explore Clairebourg : le premier jour il découvre un lieu, puis un jour sur deux il **dépose son CV dans un lieu de sa ville** (Boulangerie du Lac, Librairie des Tilleuls…). Ce sont **ses** candidatures, créées par ses aventures ; tes entreprises (EDF…) n'apparaissent jamais chez lui. 40 candidatures de ton côté ne font pas 40 aventures.
- **Le seul lien avec toi : tes nouvelles, en décalé.** Quand une de tes candidatures a une nouvelle (entretien, relance faite ou arrivée à sa date, refus), **une de ses candidatures à lui** vit la même nouvelle quelques jours après : la plus ancienne qu'il a déposée et qui n'a pas encore de nouvelles (sinon une candidature qu'il avait déjà envoyée dans sa ville). C'est ensuite toujours la même : il relance et passe son entretien là où il a déposé son CV.
- Son aventure du jour est choisie au moment où tu l'envoies, puis **ne change plus** (une mise à jour de ta candidature pendant qu'il est parti comptera pour les prochaines).
- **Son calendrier**, par ordre d'importance :
  - **Entretien** : tu enregistres ton entretien (date obligatoire). Le lendemain, Milo le dit dans sa **bulle** : « 📩 Milo a reçu une demande d'entretien chez … ! Rendez-vous jeudi 1 oct. à 11 h 30 ». La veille : « 👔 Demain, Milo a un entretien ! Il aurait bien besoin d'une tenue… » (la bulle ouvre le Shop). **Son entretien a lieu 2 jours après le tien**, à une heure précise (entre 2 h et 6 h après son réveil) ; il ne peut pas partir avant. Notifications : la demande, la veille, le jour J.
  - **Refus** : il reçoit sa réponse le lendemain du tien (après son propre entretien s'il en avait un). La raison : sa tenue s'il est allé à son entretien **sans tenue** ; sinon ce que **tu as noté** (« Pourquoi, selon toi ? ») ; sinon un message simple. Il est déçu quelques secondes, puis repart.
  - **Relance** : le lendemain de ta relance (faite, ou prévue et arrivée à sa date), il **appelle**.
  - Sinon : découvrir un lieu, ou déposer son CV dans un lieu de sa ville (un jour sur deux).
- L'onglet ville montre « Les candidatures de Milo » : ses lieux, son métier visé et où il en est (CV déposé, entretien jeudi à 11 h 30, entretien passé, a relancé, pas retenu…), sans aucune mention des tiennes.
...
- **Aventures** (`missions.ts`) : durées et coûts validés ; proposés par Claude : refus 3 min / 5 ⚡ / +5 pièces, +10 pièces par découverte, heure de l'entretien de Milo tirée entre 2 h et 6 h après son réveil, Milo relance et reçoit ses refus 1 jour après toi, premier jour = découverte puis dépôt de CV un jour sur deux, choix de la candidature de Milo qui reçoit tes nouvelles (sa plus ancienne sans nouvelles), liste des tenues d'entretien (`boutique.ts`), secteurs reconnus par mots-clés, textes des aventures, des résultats et des annonces, décor intérieur provisoire (emojis) de l'entretien.
...
- **Premium** : 3 aventures par jour, 3 h d'attente après chaque retour (validé), contre 1 par jour en gratuit.
...
- **Vêtements superposés** (haut + bas + chaussures + accessoire en même temps) : demandé, **à faire plus tard** ; il faudra une image par vêtement seul, calée sur la silhouette de chaque animal.
- **Corrections du 27/09 (faites)** : un seul nom par lieu partout ; lieux de la ville d'après ce que Milo a fait ; plus aucune mention du compagnon sur les pages Candidatures ; délai Premium compté à partir du retour de Milo. Milo n'a plus aucun lien avec tes entreprises (ses candidatures sont les siennes, dans sa ville ; seules tes nouvelles le font avancer, en décalé) ; carte verte comme à l'origine (titre dans la carte, une phrase qui change, sans heure) ; annonces de son entretien dans sa bulle. Rappel : supprimer le compte remet la série 🐾 à zéro.
